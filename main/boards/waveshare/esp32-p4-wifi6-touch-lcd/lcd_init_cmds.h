#ifndef LCD_INIT_CMDS_H
#define LCD_INIT_CMDS_H
...
// ... (остальные конфигурации можно оставить как есть, если они не используются, 
// но лучше удалить всё лишнее, чтобы избежать ошибок парсинга)
#endif

#endif // LCD_INIT_CMDS_H
